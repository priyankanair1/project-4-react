...
(async function() {
  ...
  const products = await Product.create([
    ...
    {name: 'Beetroot', description: 'Product description', category: categories[0], unit:'lb', price: 1.95, image: 'https://as1.ftcdn.net/v2/jpg/05/45/47/48/1000_F_545474888_xq2iUjyEXPRruiIYQ62U0LCtKBiZMFk9.webp'},
