...
export default function ProductDetails({ product, handleAddToOrder, handleChangeQty }) {
          ...
          <div className="col-lg-6">
            <div className="row m-sm-0">
              ...
              <div className="col-sm-10 order-1 order-sm-2">
                <div className="swiper product-slider swiper-initialized swiper-horizontal swiper-pointer-events">
            ...
            <div className="row align-items-stretch mb-4">
              ...
              <div className="col-sm-3 pl-sm-0">
                <a
                  ...
                  href="#" onClick={() => handleAddToOrder(product._id, quantity)}
                >
                  Add to cart
                </a>
              </div>
